...
<div class="flex flex-row justify-items-center justify-center p-8" >
  ...
  <NuxtLink class="self-stretch mx-2  p-2 border-2 border-black  rounded-lg bg-stone-100 text-gray-500 font-bold" :to="next_tweet">Submit</NuxtLink>
    ...
    <div class="flex flex-row justify-items-center p-8">
        <div class="basis-1/2 w-fit flex flex-col mr-8">
          ...
          <div >
              <h3 class="text-xl my-4">Type:</h3>
              <div class="flex flex-row gap-4">
                  <div @click.self="changeUrl" data-url-black="https://rlv.zazzle.com/svc/view?pid=235293855806478511&realview=113562383382757001&style=hanes_mens_crew_darktshirt_5250&size=a_s&color=black&max_dim=1028&at=238414036962221940&t_image1_url=" data-url-white="https://rlv.zazzle.com/svc/view?pid=235293855806478511&realview=113562383382757001&max_dim=1024&at=238414036962221940&t_image1_url=" data-type="t-shirt" :class="image.type == 't-shirt' ? typeActiveBtnClasses : typeDESActiveBtnClasses" >
        ...
        <div class="basis-1/2"><h1 id="hhs"></h1><img id="img" class="rounded-lg border-2 border-black" :src="image_url" /></div>
    </div>
</section>
</template>
